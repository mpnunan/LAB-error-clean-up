...
import {
  houses, students, voldysArmy
} from '../utils/data/sortingHatArrays';
import {
  renderToDOM, htmlStructure, header, startSortingBtn, studentAreas, filterBtnRow
} from '../utils/htmlBuild';
